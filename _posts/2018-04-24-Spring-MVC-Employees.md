...
<script>
	$(document).ready(function() {
		...
		// select 태그에 기존 값 설정
		var job_id= "${employeeInfo.job_id}";
		var dept_id= "${employeeInfo.dept_id}";
		var reg_id= "${employeeInfo.reg_id}";
		
		$("select#job_id option").each(function(){
	        if($(this).val()==job_id){
	            $(this).attr("selected","selected");    
	        }
	    });
		$("select#dept_id option").each(function(){
	        if($(this).val()==dept_id){
	            $(this).attr("selected","selected");    
	        }
	    });
		$("select#reg_id option").each(function(){
	        if($(this).val()==reg_id){
	            $(this).attr("selected","selected");    
	        }
	    });
					...
					<form role="form"
						...
						<div class="form-group">
							<label for="eid">사번:</label> <input type="text"
								...
								value="${employeeInfo.eid}" readonly="readonly">
						</div>
						<div class="form-group">
							<label for="name_">이름:</label> <input type="text"
								class="form-control" id="name_" name="name_"
								value="${employeeInfo.name_}" maxlength="30" required="required">
						</div>
						<div class="form-group">
							<label for="ssn">주민번호(뒷자리):</label> <input type="number"
								class="form-control " id="ssn" name="ssn"
								value="${employeeInfo.ssn}" min="1000000" max="9999999"
								required="required">
						</div>
						...
						<div class="form-group">
							<label for="phone">전화번호:</label> <input type="text"
								class="form-control" id="phone" name="phone"
								value="${employeeInfo.phone}" maxlength="30" required="required">
						</div>
						<div class="form-group">
							<label for="hiredate">입사일:</label> <input type="date"
								class="form-control" id="hiredate" name="hiredate"
								value="${employeeInfo.hiredate}" required="required">
						</div>
						<div class="form-group">
							<label for="reg_id">지역:</label> <select class="form-control"
								id="reg_id" name="reg_id">
						...
						<div class="form-group">
							<label for="basicpay">기본급:</label> <input type="number"
								class="form-control" id="basicpay" name="basicpay"
								value="${employeeInfo.basicpay}" required="required">
						</div>
						<div class="form-group">
							<label for="extrapay">수당:</label> <input type="number"
								class="form-control" id="extrapay" name="extrapay"
								value="${employeeInfo.extrapay}" required="required">
						</div>
