...
layout: post
title: "Filter"
description: "MVC pattern - Filter"
categories: [MVC, Servlet]
tags: [MVC, Servlet, Filter, login]
redirect_from:
  - /2018/04/02/
---
...
**※주의) 라이브러리 필요 - jstl-1.2.jar**



# 캐릭터 인코딩 필터

## com.util.CharactorEncodingFilter.java
...
<web-app xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
	...
	<display-name>membersMVC_20180402</display-name>
	<welcome-file-list>
...
<web-app xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
	...
	<servlet>
		...
		<servlet-class>com.test.LoginController</servlet-class>
	</servlet>
	<servlet-mapping>
		<servlet-name>LoginController</servlet-name>
